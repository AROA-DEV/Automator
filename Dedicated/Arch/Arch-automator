...
# simple options output
    ...
    # Vulnerability Detection tool Installation
    4 ) echo ;
        echo Remember some of the packets will be installed on the active directory;
        echo installing in:;
        pwd ;
...
# full system set up
    ...
    systemsetup ) apt install sudo;
                  ...
                  chmod +x automator;
                  wget https://raw.githubusercontent.com/AROA-DEV/automator/Beta-testing/Dedicated/Arch/Arch-automator.sh; # change link when pass to release version;
